...
exports.applyServiceName = applyServiceName;
/**
 ...
 */
function applyServiceName(service, name, Characteristic) {
    service.displayName = name;
    service.setCharacteristic(Characteristic.Name, name);
    if (Characteristic.ConfiguredName) {
        const c = service.getCharacteristic(Characteristic.ConfiguredName);
        c.updateValue(name);
        c.onSet(() => {
...
//# sourceMappingURL=applyServiceName.js.map